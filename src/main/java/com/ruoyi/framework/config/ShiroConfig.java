...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/system/parcel/**", "anon");
        filterChainDefinitionMap.put("/profile/**", "anon");
        filterChainDefinitionMap.put("/system/goods/**", "anon");
        filterChainDefinitionMap.put("/system/miandan/**", "anon");
        filterChainDefinitionMap.put("/system/userOrder/**", "anon");
        filterChainDefinitionMap.put("/send-message", "anon");
