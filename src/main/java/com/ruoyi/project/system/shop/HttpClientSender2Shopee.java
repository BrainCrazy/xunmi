package com.ruoyi.project.system.shop;

import com.ruoyi.common.utils.ShopeeUtil;
...
public class HttpClientSender2Shopee {
    ...
    public static String sendHttpPost(String host, String method, String key, String sendData) throws Exception {

        String requestUrl = host + method;

        HashMap<String, String> headers = new HashMap<String, String>();
        headers.put("Authorization", ShopeeUtil.sign(method, key, sendData));
