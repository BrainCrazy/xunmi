...
public class sendMsg {
    ...
    public static String sendMsg1(String code, String phone) throws Exception {

        //必填,请参考"开发准备"获取如下数据,替换为实际值
        String url = "https://rtcsms.cn-north-1.myhuaweicloud.com:10743/sms/batchSendSms/v1"; //APP接入地址+接口访问URI
        String appKey = "93S24Z9A292vDg3jYnV0x5CTx95W"; //APP_Key
        String appSecret = "Td108AuITcWX7sh4t70J95n195hu"; //APP_Secret
        String sender = "8819112223417"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "6acd597258574055ba5a4e927e52db0c"; //模板ID

        //条件必填,国内短信关注,当templateId指定的模板类型为通用模板时生效且必填,必须是已审核通过的,与模板类型一致的签名名称
        //国际/港澳台短信不用关注该参数
        String signature = "屹轩国际物流"; //签名名称
